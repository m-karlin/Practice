...
namespace App.Tests
{
    public class DepthFirstSearchTests
    {
        ...
        public void TryFindNode_ExistingNodeInTreeWithoutCycles_ReturnsTrueAndCorrectNode()
        {
            ...
            var root = new DepthFirstSearch.Node<int>(rootId);
            var node2 = new DepthFirstSearch.Node<int>(node2Id);
            var node3 = new DepthFirstSearch.Node<int>(node3Id);
            var node4 = new DepthFirstSearch.Node<int>(node4Id);
